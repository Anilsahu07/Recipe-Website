  ...
  return (
    <div className='w-full flex justify-center p-9 bg-slate-50'>
      <form action="" className=' text-black flex flex-col justify-center gap-2 items-center rounded-xl p-4 w-screen' onSubmit={handleSubmit(formSubmitHandler)}>
        ...
        <textarea className='p-3 w-full rounded border-b-2 border-black' {...register("description")}  placeholder='Enter description'></textarea>
        <textarea className='p-3 rounded border-b-2 border-black w-full' {...register("instructions")}  placeholder='Enter instructions'></textarea>
        <textarea className='p-3 rounded border-b-2 border-black w-full' {...register("ingradients")} placeholder='Enter ingradients'></textarea>
