...
const Favourite = () => {
 const {fav,setfav,info,setselectRecipe}= useContext(RecipeContext)
  ...
  if (fav.length<1) {
    return <div className='w-screen h-full flex justify-center items-center mt-5'><h1 className='text-2xl font-semibold text-green-600 font-[poppins]'>No Recipe Added to Favourite !! 😔</h1></div>
  }
