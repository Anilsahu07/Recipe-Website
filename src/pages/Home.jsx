...
const Home = () => {
  ...
  return (
    <div className=' h-full p-1 w-full'>
      ...
      <h1 style={{textShadow:"9px 3px 9px rgba(1,2,3,1)"}} className='font-[poppins] text-gray-200 font-bold text-3xl lg:text-5xl'>Explore your <br /> favourite Dishes here...</h1>
      <button onClick={navigateRecipe} className='bg-blue-600 text-white rounded px-4 py-3 hover:scale-90 hover:text-[whitesmoke] hover:font-semibold font-semibold'>SEE THEM ALL</button>
      </div>
    </div>
  )
}
