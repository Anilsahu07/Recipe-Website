...
const Search = () => {
  ...
  return (
    <div className='h-full w-screen flex justify-center flex-col items-center gap-3 p-3'>
            <h1 className='text-2xl text-wrap font-bold font-[montserrat] flex gap-2 justify-center items-center'>Search <h1 className='text-red-600 text-xl underline'>youR</h1> Recipe</h1>
